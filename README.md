...
```bash
git clone git@github.com:ChrisOgden/gstack-extend-cto.git ~/.claude/skills/gstack-extend-cto
~/.claude/skills/gstack-extend-cto/setup
```

Installs all skills into `~/.claude/skills/` as symlinks back to this repo.
To uninstall: `~/.claude/skills/gstack-extend-cto/setup --uninstall`
